...
} from "./api2"; // Stelle sicher, dass du den korrekten Pfad verwendest

export default function LagerUebersicht({ route }) {
    ...
    const handleMinusPress = (idToken) => {
